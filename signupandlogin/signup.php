		...
		<section id="home" class="welcome-hero">
			...
			<div class="container">
				<div class="welcome-hero-txt">
					<form action="/assets/php/signup.php" method="post" class="signupcontainer"> 
						<label class="hertop">Sign UP</label><br><br>
						<label for="fname">First name:</label><br>
						<input class="textcss" type="text" id="fname" name="fname"><br>

						<label for="lname">Last name:</label><br>
						<input class="textcss" type="text" id="lname" name="lname"><br><br>

						<label for="username">Username</label><br>
						<input class="textcss" type="text" id="username" name="username"><br>

						<label for="password">Password</label><br>
						<input class="textcss" type="password" id="lname" name="password"><br><br>

						<input type="radio" id="id_crad" name="idcradorPassport" value="id_crad">
						<label for="id_crad">ID CRAD</label>
						<input type="radio" id="passport" name="idcradorPassport" value="passport">
						<label for="passport">PASSPORT</label><br><br>
						<label for="idcrad_Passport">ID CRAD or Passport</label><br>
						<input class="textcss" type="text" id="idcrad_Passport" name="idcrad_Passport"><br>
