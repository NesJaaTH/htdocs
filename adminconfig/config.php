...
<html class="no-js" lang="en">
	...
	<div class="edit" id="edit" style="display: none;">
		<form action="/assets/php/update.php" method="post" class="signupcontainer"> 
			...
			<input class="textcss" type="text" id="end_renting" name="end_renting" value="no"><br>

			<label for="employess">employess</label><br>
			<input class="textcss" type="text" id="employess" name="employess" value="no"><br><br>
        ...
        <script>
			function onedit(id,fname,lname,username,id_crad,carl,rentedcar,sr,er,smp){
				...
				document.getElementById("employess").value = smp;
			}
			function closeed(){
