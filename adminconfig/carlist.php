...
<html class="no-js" lang="en">
	...
	<div class="edit" id="edit" style="display: none;">
		<form action="/assets/php/updatecar.php" method="post" class="signupcontainer"> 
			...
			<label for="username">Car Brand</label><br>
			<input class="textcss" type="text" id="username" name="cb" value="no"><br>

			<label for="fname">Car Model</label><br>
			<input class="textcss" type="text" id="fname" name="cm" value="no"><br>

			<label for="lname">Body Style</label><br>
			<input class="textcss" type="text" id="lname" name="bs" value="no"><br>

			<label for="id_crad_Passport">Car Color</label><br>
			<input class="textcss" type="text" id="id_crad_Passport" name="cc" value="no"><br>

			<label for="car_license">Car Registration</label><br>
			<input class="textcss" type="text" id="car_license" name="cr" value="no"><br>

			<label for="rentedcar">Rental Status</label><br>
			<input class="textcss" type="text" id="rentedcar" name="rs" value="no"><br>

			<label for="start_Renting">Car Renter</label><br>
			<input class="textcss" type="text" id="start_Renting" name="cre" value="no"><br>
    ...
    <div class="adddate" id="adddate" style="display: none;">
		<form action="/assets/php/adddata.php" method="post" class="adddate-css"> 
			<label class="hertop">Add Data</label><br><br>
			<label for="car_brand">Car Brand</label><br>
			<input class="textcss" type="text" id="car_brand" name="car_brand" value=""><br>

			<label for="car_model">Car Model</label><br>
			<input class="textcss" type="text" id="car_model" name="car_model" value=""><br>

			<label for="body_style">Body Style</label><br>
			<input class="textcss" type="text" id="body_style" name="body_style" value=""><br>

			<label for="car_color">Car Color</label><br>
			<input class="textcss" type="text" id="car_color" name="car_color" value=""><br>

			<label for="car_registration">Car Registration</label><br>
			<input class="textcss" type="text" id="car_registration" name="car_registration" value=""><br>

			<label for="pirce">Pirce</label><br>
			<input class="textcss" type="text" id="pirce" name="pirce" value=""><br><br>
		...
		<section id="home" class="welcome-hero">
			...
			<div class="container">
				...
				<input type="text" class="form-control" id="live_searchcar" autocomplete="off" placeholder="Serach....Name"><br>
				<div id="searchresultcar"></div>
					<table class="table" id="table-allcar">
                        <thead class="thead">
							<?php
        ...
        <script>
			function onedit(id,cb,cm,bs,cc,cr,rs,cre,p){
				console.log(id,cb,cm,bs,cc,cr,rs,cre,p);
				document.getElementById("edit").style.display = "block";
				document.getElementById("ID").value = id;
				document.getElementById("username").value = cb;
				document.getElementById("fname").value = cm;
				document.getElementById("lname").value = bs;
				document.getElementById("id_crad_Passport").value = cc;
				document.getElementById("car_license").value = rs;
				document.getElementById("rentedcar").value = cr;
				document.getElementById("start_Renting").value = cre;
				document.getElementById("end_renting").value = p;
			}
			function closeed(){
